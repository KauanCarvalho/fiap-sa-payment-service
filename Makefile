...
.DEFAULT_GOAL := help
.PHONY: help deps setup-git-hooks lint check-coverage test test-bdd coverage-html build-api run-api run-api-air docker-up docker-down swag build-worker run-worker run-worker-air
