module github.com/KauanCarvalho/fiap-sa-payment-service
...
require (
	...
	github.com/evilmartians/lefthook v1.11.10 // indirect
	...
	github.com/vladopajic/go-test-coverage/v2 v2.14.1 // indirect
